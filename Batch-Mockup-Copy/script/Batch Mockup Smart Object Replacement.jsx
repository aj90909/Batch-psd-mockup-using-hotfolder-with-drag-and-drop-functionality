...
/*    // POINT SAMPLING
    ...
    app.foregroundColor = pointSample.color
    var docRef = app.activeDocument;
    var layerRef = docRef.layers.getByName ("color").duplicate(); //duplicates the background layer
    layerRef.name = "logo"; //renames the duplicated layer.
    docRef.activeLayer = docRef.layers.getByName ("color");//selects the Background layer
    app.activeDocument.selection.fill(app.foregroundColor, ColorBlendMode.NORMAL, 100, false); //fills background layer with white.
